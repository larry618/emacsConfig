...
This function should only modify configuration layer settings."
  (setq-default
   ...
   '(
     ;; chinese-fonts-setup
		 solidity-mode ;;; PP: this causes solidity-mode to install but it fails to load
    )
...
before packages are loaded."
  ...
  (defun toggle-monospaced-font ()
    "Toggle the Chinese font to monospaced for org table"
    (interactive)
    (if (= monospaced 0)
        (progn
          (setq monospaced 1)
          ...
          (dolist (charset '(han kana symbol cjk-misc bopomofo))
            (set-fontset-font (frame-parameter nil 'font)
                              charset
                              (font-spec :family "Hiragino Sans GB" :size 22))))
      (progn
        (setq monospaced 0)
        (dolist (charset '(han kana symbol cjk-misc bopomofo))
          (set-fontset-font (frame-parameter nil 'font)
  ...
  ;; 因为gpg-agent帮你缓存了密码！所以需要kill这个进程。
...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (yasnippet-snippets web-beautify symon string-inflection spaceline-all-the-icons all-the-icons memoize password-generator overseer org-brain nameless ivy-yasnippet ivy-xref ivy-purpose window-purpose imenu-list impatient-mode simple-httpd godoctor go-tag go-rename go-impl go-gen-test go-fill-struct evil-unimpaired evil-org evil-lion evil-goggles evil-cleverparens paredit editorconfig counsel-css centered-cursor-mode font-lock+ dotenv-mode adaptive-wrap org-mime solidity-mode yaml-mode go-guru go-eldoc company-go go-mode company-web web-mode tagedit slim-mode scss-mode sass-mode pug-mode less-css-mode haml-mode emmet-mode web-completion-data reveal-in-osx-finder pbcopy osx-trash osx-dictionary launchctl unfill org-projectile org-category-capture org-present org-pomodoro alert log4e gntp org-download mwim htmlize gnuplot fuzzy company-statistics company auto-yasnippet yasnippet ac-ispell auto-complete spinner org-plus-contrib ws-butler winum which-key wgrep volatile-highlights vi-tilde-fringe uuidgen use-package toc-org spaceline powerline smex restart-emacs request rainbow-delimiters popwin persp-mode pcre2el paradox org-bullets open-junk-file neotree move-text macrostep lorem-ipsum linum-relative link-hint ivy-hydra info+ indent-guide hydra hungry-delete hl-todo highlight-parentheses highlight-numbers parent-mode highlight-indentation hide-comnt help-fns+ helm-make helm helm-core google-translate golden-ratio flx-ido flx fill-column-indicator fancy-battery eyebrowse expand-region exec-path-from-shell evil-visualstar evil-visual-mark-mode evil-tutor evil-surround evil-search-highlight-persist evil-numbers evil-nerd-commenter evil-mc evil-matchit evil-lisp-state smartparens evil-indent-plus evil-iedit-state iedit evil-exchange evil-escape evil-ediff evil-args evil-anzu anzu evil goto-chg undo-tree eval-sexp-fu highlight elisp-slime-nav dumb-jump popup f dash s diminish define-word counsel-projectile projectile pkg-info epl counsel swiper ivy column-enforce-mode clean-aindent-mode bind-map bind-key auto-highlight-symbol auto-compile packed async aggressive-indent ace-window ace-link avy))))
(custom-set-faces
 ;; custom-set-faces was added by Custom.
 ;; If you edit it by hand, you could mess it up, so be careful.
 ;; Your init file should contain only one such instance.
